...
export function ExpenseTrackerWidget() {
  const [categories, setCategories] = useState([
    { id: 1, name: 'Utilities', budget: 5000, actual: 4500 },
    { id: 2, name: 'Groceries', budget: 12000, actual: 13500 },
    { id: 3, name: 'Transportation', budget: 4000, actual: 3200 },
    { id: 4, name: 'Entertainment', budget: 6000, actual: 5000 },
  ]);
...
export function SavingsInvestmentsWidget() {
  ...
  const [portfolio, setPortfolio] = useState([
    { id: 1, name: 'HDFC Index Fund', value: 150000 },
    { id: 2, name: 'Parag Parikh Flexi', value: 85000 },
    { id: 3, name: 'Direct Stocks', value: 45000 }
  ]);
